		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-8 text-md-right header-buttons">
					...
					<a href="/documents/{{ $osnovni->document_sr }}" class="site-btn">Preuzmi CV</a>
					@endforeach
					<a href="#kontakt" class="site-btn">Kontakt</a>
				</div>
			</div>
		</div>
	</header>
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="hero-info">
								...
								@foreach($osnovni_podaci as $osnovni)
								<ul>
										<li><span>Datum rođenja:</span>{!! $osnovni->birth !!}</li>
										<li><span>Adresa:</span>{!! $osnovni->address !!}</li>
										<li><span>E-mail:</span>{!! $osnovni->email !!}</li>
										<li><span>Telefon: </span>{!! $osnovni->phone !!}</li>
								</ul>
								@endforeach
							</div>
						</div>
			...
			<div class="row">
				<div class="col-xl-10 offset-xl-1">
					<div class="social-link-warp">
						...
						<h2 class="hidden-md hidden-sm">Profili na društvenim mrežama</h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-xl-7 offset-xl-2">
					<div class="section-title">
						<h2>Radno iskustvo kao web developer</h2>
					</div>
					<ul class="resume-list">
						@foreach($radno_iskustvo as $radno)
						  {!! $radno->short_description !!}
						@endforeach  
					</ul>
				</div>
			</div>
	...
	<section class="resume-section spad">
		<div class="container-fluid">
			<div class="row">
				<div class="col-xl-7 offset-xl-2">
					<div class="section-title">
						<h2>Radno iskustvo kao ekonomista</h2>
					</div>
					<ul class="resume-list">
						@foreach($radno_iskustvo_ek as $radno_ek)
						  {!! $radno_ek->short_description !!}
						@endforeach  
					</ul>
				</div>
			</div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xl-4 col-md-8 offset-xl-2 ">
					<div class="section-title">
						<h2>Portfolio</h2><sub>(4 izdvojena od oko 30 ukupno)</sub>
					</div>
				</div>
				...
				<div class="col-xl-8 offset-xl-2">
					...
					{!! Form::open(['route' => 'contact.store','class'=>'contact-form']) !!}
						<div class="row">
							...
							<div class="col-md-12">
								{!! Form::text('subject',null,['placeholder' => 'Naslov']) !!}
								{!! Form::textarea('message',null,['placeholder' => 'Poruka']) !!}
							</div>
						</div>
						<div class="g-recaptcha" data-sitekey="6Ld90XYUAAAAAGGe3Oa9jsf8DVL8Y41QLkgOY3f2"></div>
						<div class="text-md-right">
							{!! Form::submit('Pošalji', ['class' => 'site-btn']) !!}
						</div>
					{!! Form::close() !!}
				</div>
			</div>
